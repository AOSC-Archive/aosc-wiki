...
The rules specified below applies to all AOSC Telegram channels/groups (and their respective Discord and IRC channels/groups), the [GitHub Organisation](https://github.com/AOSC-Dev/), the [AOSC Wiki](https://wiki.aosc.io/), and the [Community Portal](https://aosc.io/).
