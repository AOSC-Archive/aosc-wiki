...
我们社区大部分的活动和交流在 Telegram 群组上开展，以下的方针会被分为“适用与全社区”和“适用于特定场景”两部分。**我们不会，也没有这个权利，去约束、限制社区成员在社区（包含所有安同开源社区 Telegram 群组、[AOSC 维基](https://wiki.aosc.io/zh/)、[GitHub 组织](https://github.com/AOSC-Dev/) 和 [社区门户](https://aosc.io/)）外的任何行为。**
