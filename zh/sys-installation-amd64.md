...
- [针对 KVM 的额外说明](/en/sys-installation-amd64-notes-kvm)
- [针对 Bay Trail/Cherry Trail 的额外说明](/en/sys-installation-amd64-notes-trails)
- [针对 software RAID 的额外说明](/en/sys-installation-amd64-notes-softraid)
