...
| Name | Port | CPU | Memory | Speed |Maintainer | Note |
|-----------|-----------|-----------|-----------|-----------|-----------|-----------|
| **lm-a1511** | ~~23072~~ | Loongson 3B-1500G (R2, Hexa) @ 1.2GHz (A1511) | 8GiB | 1333s (`-j7`, 2.27) | _Junde Yhi_ | Hosted by the Network Coding Lab at [CUHK(SZ)](http://www.cuhk.edu.cn/) sponsored by _Xiaoxing Ye_; owned by _Mingcong Bai_ |
| **lm-a1601** | ~~23141~~ | Loongson 3A-2000C (R2) @ 1GHz (A1601) | 8GiB | 801s (`-j5`, 2.27) | _Junde Yhi_ | |
| **lm-8089d** | ~~23210~~ | Loongson 2F (STLS2F02-1) @ 1GHz (Lemote Yeeloong 8089D) | 1GiB | 9077s (`-j1`, 2.27) <!-- 10038s (`-j2`) --> | _Junde Yhi_ | For testing purposes only, not 24x7 online (slow, hot and noisy); owned by _Mingcong Bai_ |
| **lpi-2** | ~~23456~~ | Loongson 2K-1000 @ 1GHz (Loongson Pi 2) | 2GiB | _Not tested yet_ | _Junde Yhi_ | Sponsored by [windows1089](http://www.openloongson.org/?4655) |

## **ARM** (24001-25000)

| Name | Port | CPU | Memory | Speed |Maintainer | Note |
|-----------|-----------|-----------|-----------|-----------|-----------|-----------|
| **ice-rockpro64** | 24064 | Quad Core ARM Cortex-A53 @ 1.416GHz + Dual Core ARM Cortex-A72 @ 1.8GHz (Rockchip RK3399, RockPro64) | 4GiB | 565s (`-j7`) | _Icenowy Zheng_ | Scratch disk at `/mnt/sda3`; users in Asia could try `ssh -p 24064 root@vmvinetedge001.aosc.on.biscuit.moe` |
