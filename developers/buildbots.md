...
| Name | Port | CPU | Memory | Speed |Maintainer | Note |
|-----------|-----------|-----------|-----------|-----------|-----------|-----------|
| **Gobson** | 23072 | Loongson 3B-1500G (R2, Hexa) @ 1.2GHz (A1511) | 8GiB | 1333s (`-j7`) | _Junde Yhi_ | Hosted by the Network Coding Lab at [CUHK(SZ)](https://www.cuhk.edu.hk/) sponsored by _Xiaoxing Ye_; owned by _Mingcong Bai_ |
