...
- The parameter speed is defined as the total execution time for `make`, after `../configure --prefix=/usr` within the unzipped source tree of GNU C Library (version 2.27).
